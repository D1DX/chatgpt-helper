...
| **Attachments** | Read an existing export JSON and download only the attachments it references as ZIP volumes (~100 MB each) + a metadata zip with `conversations.json` and `attachments-index.json` |
